(function () {
  ...
  const routes = {
    ...
    '/brand-identity': { brand: 'brand_identity', subtitle: 'مستشار الهوية الذكية - متصل الآن', replies: ['أريد تصميم هوية بصرية', 'ما خدمات الهوية البصرية؟', 'أريد عرض سعر هوية', 'ما مراحل تنفيذ الهوية؟'] },
